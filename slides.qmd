...
- This tendency is found in \textbf{different contexts}, such as restaurant reviews, tweets, open-ended surveys, and surrendering \textbf{personal information} in web advertisements
- Important \textbf{marketing implications}, e.g. conducting consumer surveys via smartphones, ideally with text boxes to leverage attentional focus
...
\textit{"The model hypothesizes two parallel causal paths of mediation: one stemming from greater focus on the disclosure at hand, and the other through feelings of enhanced psychological comfort on the device."}

\vfill

\textit{"The model hypothesized that the \textbf{direct effect}  of smartphone (vs. PC) use on human-judged depth of self-disclosure is described by \textbf{two causal paths} "}

# Lowlights: The presented framework

![Theoretical model from @melumadFullDisclosureHow2020](figure1.png)
...
- What about other devices  e.g. \textbf{Virtual Reality} $\to$ Metaverse?
